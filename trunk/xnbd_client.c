 ...
 *
 * This program is a rewritten version of nbd-client.
 *
...
int main(int argc, char *argv[]) {
	...
	errmsg:
		...
		fprintf(stderr, "Usage: nbd-client [bs=blocksize] [timeout=sec] host port nbd_device [-persist]\n");
